...
# API configuration
API_BASE_URL = "http://127.0.0.1:8000"  # Default FastAPI port
    ...
    with st.sidebar:
        ...
        if api_status:
            ...
            **To start the API server:**
            ...
            2. Navigate to the [api](cci:1://file:///c:/Users/bisht/Agent_Groq%20-%20Copy%20%282%29/streamlit_ui.py:24:0-34:60) directory
