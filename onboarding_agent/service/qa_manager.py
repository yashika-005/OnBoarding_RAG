...
from onboarding_agent.service.vector_store import VectorStoreManager
from onboarding_agent.service.document_processor import load_knowledge_base
...
class QAManager:
    ...
    def initialize_llm(self) -> bool:
        ...
        try:
            ...
            logging.info(f"LLM initialized successfully with model: {settings.LLM_MODEL}")
            return True
